...
# =========================================================================
# 3. Core Module 2: Spatial Salience Decoupling (SSD) - [UPDATED]
# =========================================================================
class SSD(nn.Module):
    def __init__(self, in_channels, k=3):
        ...
        weight = torch.ones(in_channels, 1, 3, 3)
        weight[:, :, 1, 1] = 0  
        weight = weight / 8.0   
        
        self.surround_pool = nn.Conv2d(in_channels, in_channels, kernel_size=3, 
                                       stride=1, padding=2, dilation=2, 
                                       groups=in_channels, bias=False)
        self.surround_pool.weight = nn.Parameter(weight, requires_grad=False)
...
class FSD_APAM(nn.Module):
    def __init__(self, c1, reduction=4):
        ...
        self.ssd = SSD(in_channels=c, k=3)
